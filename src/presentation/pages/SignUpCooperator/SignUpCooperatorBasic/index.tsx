...
const SignUpCooperatorBasic: React.FC = () => {
  ...
  const navigationToAccessCode = useCallback((values: FormValues): void => {
    const cooperatorParams: ParamsExportNavigation = {
      ...values,
      name: values.name.trim()
    }
    navigation.navigate('SignUpCooperatorPassword', { cooperatorParams })
  }, [])
...
export default SignUpCooperatorBasic
